...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (username != null) {
            dispatcherRepository.findByUsername(username).ifPresent(u -> setContext(request, u));
            tenantRepository.findByUsername(username).ifPresent(u -> setContext(request, u));
        }
